				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Liste des Vaccinations</h2>
						...
						<tbody>
<?php $sql = "SELECT * from dview where numero=3";
...
{				?>		
						  <tr>
							...
							<td><a href="detail-vaccination.php?id=<?php echo htmlentities($result->id);?>"><button type="button"  class="btn btn-primary btn-block">Details</button></a></td>
